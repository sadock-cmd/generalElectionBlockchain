...
const Home = () => {
    ...
    <div className="row text-black">
      <div className="col-lg-14">
        ...
        To get ethers click one of the following links :<a href='https://faucet.egorfine.com/' target="_blank">link 1,</a> <a href='https://faucet.dimensions.network/' target="_blank">link 2,</a> <a href='https://ropsten.chain.link/' target="_blank">link 3.</a><br/>

        Live voting functionality is implemented, you will be able to view the votes as they are being cast. To this end, this blockchain voting solution provides voters with a way to confirm that their voice has been heard and that election results, as a whole, are truly accurate.
        <br/>
        </p>
